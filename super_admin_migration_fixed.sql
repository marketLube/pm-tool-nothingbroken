-- Super Admin System Migration (Fixed Column Names)
...
DROP POLICY IF EXISTS "Only Super Admin can manage modules" ON modules;
...
DROP POLICY IF EXISTS "Only Super Admin can manage module permissions" ON module_permissions;
